        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "costumer"),
                    PhoneNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Password = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    IsTwoFactorEnable = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAutoPayEnable = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bills_Amount_NonNegative", "[Amount] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MoneyTransactions_Amount_NonNegative", "[Amount] >= 0");
                    table.ForeignKey(
                        name: "FK_MoneyTransactions_Users_ReceiverUserId",
                        column: x => x.ReceiverUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MoneyTransactions_Users_SenderUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsUsedCode = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "SettingEntity",
                columns: new[] { "Id", "CreatedDate", "IsDeleted", "MaintenanceMode", "ModifedDate" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoneyTransactions_ReceiverUserId",
                table: "MoneyTransactions",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MoneyTransactions_SenderUserId",
                table: "MoneyTransactions",
                column: "SenderUserId");
